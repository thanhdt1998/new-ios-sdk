...
#import "VMGLTileServerOptions.h"
...
FOUNDATION_EXTERN MGL_EXPORT VMGLExceptionName const MGLInvalidStyleURLException;
FOUNDATION_EXTERN MGL_EXPORT VMGLExceptionName const MGLRedundantLayerException;
FOUNDATION_EXTERN MGL_EXPORT VMGLExceptionName const MGLRedundantLayerIdentifierException;
FOUNDATION_EXTERN MGL_EXPORT VMGLExceptionName const MGLRedundantSourceException;
FOUNDATION_EXTERN MGL_EXPORT VMGLExceptionName const MGLRedundantSourceIdentifierException;
 ...
 */
@property (nonatomic, strong) NSSet<__kindof VMGLSource *> *sources;
 ...
 */
- (nullable VMGLSource *)sourceWithIdentifier:(NSString *)identifier;
 ...
 */
- (void)addSource:(VMGLSource *)source;
 ...
 */
- (void)removeSource:(VMGLSource *)source;
 ...
 */
- (BOOL)removeSource:(VMGLSource *)source error:(NSError * __nullable * __nullable)outError;
...
/**
 ...
 @note The default styles provided by Mapbox contain sources and layers with
    ...
    `+[MGLStyle outdoorsStyleURLWithVersion:]` or a manually constructed
     `NSURL`.
 */
@property (nonatomic, readonly, nullable) VMGLStyle *style;
