 ...
 */
- (instancetype)initWithStyleURL:(nullable NSURL *)styleURL camera:(VMGLMapCamera *)camera size:(CGSize)size;
 ...
 */
@property (nonatomic) VMGLMapCamera *camera;
 ...
 */
@property (nonatomic) VMGLCoordinateBounds coordinateBounds;
 ...
 */
- (void)mapSnapshotter:(MGLMapSnapshotter *)snapshotter didFinishLoadingStyle:(VMGLStyle *)style;
